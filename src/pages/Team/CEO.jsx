          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            >
              ...
              <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed">
                <p>
                  Muhammad Monir Hossain is a visionary leader with a proven
                  track record of driving digital transformation. As the CEO of
                  Betopia Group, he leads with purpose—bridging technology and
                  business strategy to create scalable, secure, and future-ready
                  ecosystems.
                </p>
                <p>
                  With his deep understanding of B2B markets, he ensures every
                  initiative is designed to deliver sustainable growth and
                  long-term success for partners. His leadership philosophy is
                  rooted in innovation, adaptability, and creating meaningful
            ...
            >
              ...
              <p className="text-blue-500 font-black text-[10px] uppercase tracking-[0.4em]">
                Managing director and group CEO // Betopia Group
              </p>
            </motion.div>
          </div>
        </div>
